...
public class GradeProcessorTest {
    ...
    public void roundTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.round(-13), SHOULD_THROW_EXCEPTION);
        assertThrows(RuntimeException.class, () -> gradeProcessor.round(202), SHOULD_THROW_EXCEPTION);
    }
    ...
    public void addToArrayTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.addToArray(grades, -10), SHOULD_THROW_EXCEPTION);
    }
    ...
    public void insufficientGradesTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.insufficientGrades(new int[]{31, 53, 12, 1010}), SHOULD_THROW_EXCEPTION);
    }
    ...
    public void sufficientGradesTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.sufficientGrades(new int[]{31, -53, 12, 1010}), SHOULD_THROW_EXCEPTION);
    }
    ...
    public void averageTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.average(new int[]{31, -53, 12, 1010}), SHOULD_THROW_EXCEPTION);
        assertThrows(RuntimeException.class, () -> gradeProcessor.average(new int[0]), SHOULD_THROW_EXCEPTION);
    }
    ...
    public void roundAllGradesTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.roundAllGrades(new int[]{31, -53, 12, 1010}), SHOULD_THROW_EXCEPTION);
    }
    ...
    public void maxGradeTest() {
        ...
        assertThrows(RuntimeException.class, () -> gradeProcessor.maxGrade(new int[]{31, -53, 12, 1010}), SHOULD_THROW_EXCEPTION);
        assertThrows(RuntimeException.class, () -> gradeProcessor.maxGrade(new int[0]), SHOULD_THROW_EXCEPTION);
    }
}
